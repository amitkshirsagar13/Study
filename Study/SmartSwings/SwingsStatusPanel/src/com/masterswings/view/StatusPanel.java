...
public class StatusPanel extends BasePanel implements MouseListener, Runnable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	static Logger _log = Logger.getLogger(StatusPanel.class.getName());

	private static StatusPanel _statusPanel = null;

	private StatusPanel() {
	}

	public static StatusPanel loadPanel(JFrame mainFrame, String layOut) {
	...
	public void updateStatusBarMessage() {
		System.out.println("Updated StatusBar:" + this.statusMessage);
