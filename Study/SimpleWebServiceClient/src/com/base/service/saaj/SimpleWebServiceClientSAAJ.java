...
public class SimpleWebServiceClientSAAJ {
	...
	public static void main(String[] args) {
		try {
			...
			String url = "http://localhost:8080/SimpleWebService/myZooService";
	...
	private static String serviceURI = "http://service.base.com/";
