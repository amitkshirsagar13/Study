 ...
 * </pre>
 */
public class SystemUser extends BaseEntity implements AbsBaseConstants {
	...
	public String toString() {
		return "SystemUser: " + id + CONNECTOR + name + CONNECTOR + emailId
				+ CONNECTOR + systemRole + CONNECTOR + crtDate;
	}
