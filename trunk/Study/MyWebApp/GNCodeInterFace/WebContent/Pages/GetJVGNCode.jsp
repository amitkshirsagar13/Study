...
<h2>Update GNCode Mapping for the JV Idex.</h2>
...
<table border="1" >
	...
	<tr>
		...
		<td colspan="2"><input type="text" size="30" id="court" name="court" value="${SaveUpdateForm.court}"
			onkeyup="showResult(this.value,this.id,'GNCODE_JV_LOOKUP')" />
		<div id="courtList">&nbsp;</div>
		</td>
	</tr>
	<tr><td colspan="2"><font color="red"><b>City Name:</b></font></td>
		<td colspan="2"><input type="text" size="30" id="city" name="city" value="${SaveUpdateForm.city}"
			onkeyup="showResult(this.value,this.id,'GNCODE_JV_LOOKUP')" />
		<div id="cityList">&nbsp;</div>
		</td>
	</tr>
	<tr>
		...
		<td colspan="2"><input type="text" size="30" id="state_name" name="state_name" value="${SaveUpdateForm.state_name}"
			onkeyup="showResult(this.value,this.id,'GNCODE_JV_LOOKUP')" />
	...
	<tr>
		<td align="center">
			<input type="checkbox" name="GNCODECHKID" id="GNCODECHKID" value="GNCODECHKID" onclick="getGNCODEIDChange(this.name,'JV')"/>Get GNCode From <font color="red"><b>GNCode Value</b></font>
		</td>
		<td colspan="3" align="center">
			<input id="GNCODEINFO" type="button" value="Get GNCode Information from Normalized Name" onClick="getGNCodeInfoData(this.id,'JV')">
		</td>
	</tr>
	<tr>
		<td>GNCode ID:</td>
